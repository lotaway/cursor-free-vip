# Maintainer: lotaway <lotaway@foxmail.com>
...
arch=('x86_64')
url="https://github.com/lotaway/cursor-free-vip"
license=('MIT')
depends=('python' 'cursor-bin')
makedepends=('git' 'python' 'pyinstaller' 'uv')
provides=('cursor-free-vip')
source=("cursor-free-vip::git+https://github.com/lotaway/cursor-free-vip.git")
sha256sums=('SKIP')
