...
def modify_workbench_js(file_path: str, translator=None) -> bool:
    ...
    try:
        ...
        with tempfile.NamedTemporaryFile(mode="w", encoding="utf-8", errors="ignore", delete=False) as tmp_file:
            ...
            patterns = {
                r'B(k,D(Ln,{title:"Upgrade to Pro",size:"small",get codicon(){return A.rocket},get onClick(){return t.pay}}),null)': r'B(k,D(Ln,{title:"Project Home",size:"small",get codicon(){return A.github},get onClick(){return function(){window.open("https://github.com/lotaway/cursor-free-vip","_blank")}}}),null)',
                
                # Windows/Linux
                r'M(x,I(as,{title:"Upgrade to Pro",size:"small",get codicon(){return $.rocket},get onClick(){return t.pay}}),null)': r'M(x,I(as,{title:"Project Home",size:"small",get codicon(){return $.github},get onClick(){return function(){window.open("https://github.com/lotaway/cursor-free-vip","_blank")}}}),null)',
                
                r'$(k,E(Ks,{title:"Upgrade to Pro",size:"small",get codicon(){return F.rocket},get onClick(){return t.pay}}),null)': r'$(k,E(Ks,{title:"Project Home",size:"small",get codicon(){return F.rocket},get onClick(){return function(){window.open("https://github.com/lotaway/cursor-free-vip","_blank")}}}),null)',
